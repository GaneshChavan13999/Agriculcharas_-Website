...
<table style="background-color: var(--grey-alt);">
  ...
  <tbody><?php
  $ret=mysqli_query($con,"SELECT ro.orderid, f.fname , f.lname, r.fname as f1, r.lname as f2, rp.title, ro.qnt, ro.amt  FROM porders ro, user f, farmer r, fproduct rp   WHERE ro.uid= f.id AND ro.fid= r.id AND ro.pid= rp.id");

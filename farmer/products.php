  ...
  <section class="section" id="shop">
          ...
          <div class="section-title active" data-id="latest">
            ...
            <?php } elseif(isset($_GET["category"])){?>
              <h1 class="primary-title">Category: <?php
                $ret1=mysqli_query($con,"SELECT * FROM  rcategories WHERE id=".(int)$_GET["category"]);
      ...
      <?php 
        if(isset($_GET["searchfor"])){
          $ret=mysqli_query($con,"SELECT * FROM rproduct WHERE title LIKE '%".$_GET["searchfor"]."%'");
        }
        elseif(isset($_GET["category"])){
          $ret=mysqli_query($con,"SELECT * FROM rproduct WHERE category=".(int)$_GET["category"]);
        }
        else{

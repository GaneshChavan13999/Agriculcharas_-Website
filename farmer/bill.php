...
<?php include_once('./include/header.php');?>
      <div id="wrapper" style="background-color: var(--grey-alt);">
        <!-- Begin page -->
        <table name="table1">
        <caption> <h4 >Payment Reciept</h4></caption>
        <tbody>
<?php
$oid=$_GET['oid'];
$ret=mysqli_query($con,"select * from rorders where orderid='$oid'");
$cnt=1;
$cid1=0;
                ...
                <td scope="row" colspan="2">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Retailer Contact No.</th>
                    ...
                    <?php
                    $cnt1=0;
                    $ret1=mysqli_query($con1,"select * from rporders o, retailer f, rproduct p where o.rid= f.id and o.pid=p.id and o.orderid=".$oid);
                    while ($row1=mysqli_fetch_array($ret1)) { $cnt1++;?>
                     <tr>
                            ...
                            <td data-label="Farmer Name"><?php echo $row1["fname"]." ".$row1["lname"];?></td>
                            <td data-label="Farmer Contact No."><?php echo $row1["phone"];?></td>
                        ...
                        <tr>
                        <td scope="row" colspan=7 style="text-align:end;" >Total Amount</td>
                        <td data-label="Total Amount">₹<?php echo $row['amount']; ?></td>
                        </tr>
                    </tbody>
                    </table>
                </td>
                ...
                <td scope="row" colspan="2">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-label="Payment Amount"><?php echo $row['amount']; ?></td>

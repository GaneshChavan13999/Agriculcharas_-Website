...
if(isset($_POST['register']))
  {
    ...
    $sql="INSERT INTO `farmer`(`email`, `fname`, `lname`, `gender`, `phone`, `address`, `city`, `state`, `country`, `pin`, `acnum`, `acname`, `ifsc`, `pass`) VALUES (
        '".$user."',
        '".$fname."',
        '".$lname."',
        '".$gender."',
...
<div class="body">
<div class="block1">
<p class="head1">Farmer Registration</p><hr>

  ...
  $orderid=0;
      ...
      try{
          if(isset($_POST["card_num"])){
            ...
            $sql="INSERT INTO `uorders`(`orderid`, `uid`, `name`, `email`, `addr`, `city`, `state`, `pincode`, `card_name`, `card_num`, `card_cvc`, `card_exp_month`, `card_exp_year`, `amount`) VALUES (
                ".$orderid.",
                ".$uid.",
                '".$name."',
                '".$email."',
              ...
              for($i=0; $i< count($a)-1; $i++){
                ...
                $sql1="INSERT INTO `porders`(`orderid`, `uid`, `fid`, `pid`, `qnt`, `amt`) VALUES (
                  ...
                  $result1=$con->query($sql1);
                            ...
                            $success=1;
                // header("location: reciept.php?oid=".$orderid);
              }
              else{
...
<script type="text/javascript">
            localStorage.clear();
            location.href='reciept.php?oid='+<?php echo $orderid;?>;
        </script>
<?php 
}
?>  

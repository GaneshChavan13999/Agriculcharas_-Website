...
if(isset($_POST['register']))
  {
    ...
    $sql="INSERT INTO `retailer`(`email`, `fname`, `lname`, `gender`, `phone`, `address`, `city`, `state`, `country`, `pin`, `acnum`, `acname`, `ifsc`, `pass`) VALUES (
        '".$user."',
        '".$fname."',
        '".$lname."',
        '".$gender."',
...
<link rel="stylesheet" type="text/css" href="css/reg.css" />
   ...
   .e{
	 ...
	 <script>
        ...
        var acnum = document.forms["register"]["acnum"].value;
        var acname = document.forms["register"]["acname"].value;
        var ifsc = document.forms["register"]["ifsc"].value;
        ...
        && country != "" && acnum != "" && acname != "" && ifsc != "" && pass != "" && cpass != ""){
            if(fname.match(letters) && lname.match(letters) && state.match(letters) && city.match(letters) && country.match(letters) && acname.match(letters) &&
            phone.match('[0-9]{10}') && pin.match('[0-9]{6}') && acnum.match(num) && pass==cpass){
                return true;
            }
...
<div class="body">
<div class="block1">
<p class="head1">Retailer Registration</p><hr>
...
<div class="span12">Bank Account Number <input class="inp5" type="text" name="acnum" required></div>
			
<div class="span13">Bank Account Holder name <input class="inp5" type="text" name="acname" required></div>
<div class="span14">Bank IFSC code <input class="inp5" type="text" name="ifsc" required></div>
</fieldset></div>

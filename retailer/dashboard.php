...
<body>
  ...
  <main>
          ...
          <ul class="glide__slides glide__hero">
            ...
            <li class="glide__slide">
              <div class="banner">
                <div class="banner-content">
                  ...
                  <h1>AGRICULTURAL MACHINERY <br> FOR FARMERS!</h1>
                  <h3>DIRECTLY YOUR COMPANY <BR>TO YOUR FARMERS</h3>
                  <div class="buttons-group">
                  <a href="addproduct.php"><button>SELL NOW</button></a>
                  </div>
                </div>
            ...
            <li class="glide__slide">
              <div class="banner banner1">
                <div class="banner-content">
                <span>New Inspiration 2021</span>
                  <h1>BEST SAPLINGS AND<br> SEEDS FOR FARMERS!</h1>
                  <h3>DIRECTLY YOUR COMPANY <BR>TO YOUR FARMERS</h3>
                  <div class="buttons-group">
                  <a href="addproduct.php"><button>SELL NOW</button></a>
                  </div>
            ...
            <li class="glide__slide">
              <div class="banner">
                <div class="banner-content">
                <span>New Inspiration 2021</span>
                  <h1>CROP PROTECTION AND<br> NUTRITION PRODUCTS <br>FOR FARMERS!</h1>
                  <h3>DIRECTLY YOUR COMPANY <BR>TO YOUR FARMERS</h3>
                  <div class="buttons-group">
                  <a href="addproduct.php"><button>SELL NOW</button></a>
                  </div>
    ...
    <section class="section category">
      <h2 class="title">Agriculture with a new Skill.</h2>
      <div class="category-center container">
        ...
        <div class="category-box">
          ...
          <div class="content">
            ...
            <a href="addproduct.php">Sell now</a>
          </div>
        </div>
